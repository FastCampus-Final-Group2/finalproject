...
/* todos: 
  ...
  팝업 내 설명 워딩 다른 내용 체크 (배송취소 팝업)
  지도 확대 표시 바 지속적으로 보여지는 부분 수정
  이슈 메모 저장 후 저장된 내용 출력 기능 재확인
  배차 취소 했을 때 취소된 주문 타임라인 파란 아이콘으로 표시됨 + 취소 후에도 ‘선택된 주문 수’ 값 안에 포함되어있음→ 타인라임 컴포넌트 중 선택 불가 내용 색상 수정 & 선택된 주문 수 카운트 오류 수정
  팝업에서 confirmed 미표시 → confirmed 문구&체크 박스 표시

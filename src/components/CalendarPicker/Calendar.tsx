...
const Calendar = ({ startDate, onDateClick, pastDisabled }: CalendarProps) => {
  ...
  return (
    <div className="flex flex-col border-r border-gray-100">
      ...
      <div className="flex justify-center gap-3">
        <Month month={currentMonth} startDate={startDate} onDateClick={onDateClick} pastDisabled={pastDisabled} />
      </div>
    </div>
  );
};

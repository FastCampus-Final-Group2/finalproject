...
const StopOver = ({
  ...
  const getErrorMessage = (
    ...
    if (restrictedTonCode || entryRestricted) {
      errorMessages.push(
        <div className="inline-flex items-center gap-[4px]">
          ...
          <div className="text-center text-red-500 text-B-14-M">진입제약 차량</div>
        </div>,
      );
    }
    ...
    if (overContractNum) {
      errorMessages.push(
        <div className="inline-flex items-center gap-[4px]">
          <Icon id="warning" size={14} className="text-red-500" />
          <div className="text-center text-red-500 text-B-14-M">가용주문 초과</div>
        </div>,
      );
    }

    if (overFloorAreaRatio) {
      errorMessages.push(
        <div className="inline-flex items-center gap-[4px]">
          <Icon id="warning" size={14} className="text-red-500" />
  ...
  return (
    <>
      <div className="inline-flex items-start justify-start gap-[20px] self-stretch" {...dargHandleProps}>
                ...
                <div className="inline-flex items-center justify-start gap-[8px] self-stretch">
                  {deliveryDestinationId !== 0 ? (
                    <>
                      ...
                      >
                        <div className="text-center text-blue-500 text-T-16-M">{lotNumberAddress}</div>
                        <div className="text-center text-blue-500 text-T-16-M">{detailAddress}</div>
                      </button>
                    </>
                  ) : (
                    <>
                      <div className="flex items-center justify-start gap-[4px] truncate border-b border-blue-500 pt-[1px]">
                        <div className="text-center text-black text-T-16-M">{lotNumberAddress}</div>
                        <div className="text-center text-black text-T-16-M">{detailAddress}</div>
                      </div>
                    </>
                  )}
                </div>
            ...
            <div className="inline-flex items-center justify-center gap-[8px]">
              ...
              {breakStartTime && breakEndTime ? (
                ...
                <div className="flex h-[28px] items-center justify-end py-[4px]">
                  ...
                  <div className="flex items-center justify-start">
                    <div className="text-center text-gray-700 text-B-14-R">
                      {formatTime(expectationOperationEndTime)}
                    </div>
                  </div>
                </div>
              )}
